  ...
  return (
    <>
      ...
      <div className="ProjectDiv">
        <h1 className="Title TitleMain">Explication du projet</h1>
        ...
        j'ai choisi une API de cinéma <Link to = "https://www.omdbapi.com/">Omdbapi</Link> car le cinéma est une de mes passions!</p>

        <p className="ProjectParagraph">J'ai utilisé React Router pour la navigation, j'ai utilisé fetch pour réaliser mes requête API et non pas React Query, bien que j'ai lu la documentation, car je ne l'ai jamais utilisé et que
        ...
        regarder les informations suivantes: le casting, les critiques de la presse ainsi que le synopsis. Cette fois ci, c'est une requête par ID de film !
         </p>
        <p className="ProjectParagraph">J'ai repris certains éléments du site de <Link to = "https://www.spallian.com/">Spallian</Link> comme le logo ou les couleurs principales.
        J'espère que mon site est convivial et réactif et que vous avez passé un agréable moment!</p>

        <p className="ProjectParagraph">Thibaud Delvert</p>
      </div>
    </>
  );
};
