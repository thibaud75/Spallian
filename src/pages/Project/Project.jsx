  ...
  return (
    <>
      ...
      <div className="ProjectDiv">
        ...
        <p className="ProjectParagraph">J'ai utilisé React Router pour la navigation et ses outils comme Outlet, j'ai utilisé fetch pour réaliser mes requête API et non pas React Query, bien que j'ai lu la documentation, car je ne l'ai jamais utilisé et que
